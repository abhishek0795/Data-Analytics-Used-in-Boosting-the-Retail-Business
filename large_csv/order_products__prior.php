      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a class="active" href="./order_products__prior.php">Order_Products__Prior</a></li>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
  				...
  				<div class="panel-body">
                    ...
                    <form method="post" action="export_order_products__prior.php" enctype="multipart/form-data">
                    <input type="submit" name="export_order_products__prior" value="Export" class="btn btn-danger">
                    </form>
                    </div>
		...
		<div class="container">
		<h1 style="color:#262496" class="text-center">Displaying Order_Products__Prior CSV Data From MySQL Database </h1>
        ...
        <th style="background-color: purple;color: white;">Order_Id</th>
        <th style="background-color: purple;color: white;">Product_Id</th>
        <th style="background-color: purple;color: white;">Add_to_Cart_Order</th>
        <th style="background-color: purple;color: white;">Reordered</th>
        </tr>
	</body>
</html>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#sample_form').on('submit', function(event){
			...
			$.ajax({
				url:"upload_order_products__prior.php",
				method:"POST",
		...
		function start_import()
		{
			...
			$.ajax({
				url:"import_order_products__prior.php",
				success:function()
				{
		...
		{
			$.ajax({
				url:"process_order_products__prior.php",
				success:function(data)
				{
 ...
 <?php
  ...
  if(isset($_POST["display"])){
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["order_id"]. "</td><td>" . $row["product_id"]. "</td><td>"  .$row["add_to_cart_order"]. "</td><td>" . $row["reordered"]."</td></tr>";
    }}
  echo "<table>";
  $conn->close();
  ?>

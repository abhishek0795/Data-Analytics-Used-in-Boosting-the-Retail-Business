      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<li><a class="active" href="./order_products__train.php">Order_Products__Train</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
  				...
  				<div class="panel-body">
                    ...
                    <form method="post" action="export_order_products__train.php" enctype="multipart/form-data">
                    <input type="submit" name="export_order_products__train" value="Export" class="btn btn-danger">
                    </form>
                    </div>
		...
		<div class="container">
		<h1 style="color:#262496" class="text-center">Displaying Order_Products__Train CSV Data From MySQL Database </h1>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#sample_form').on('submit', function(event){
			...
			$.ajax({
				url:"upload_order_products__train.php",
				method:"POST",
		...
		function start_import()
		{
			...
			$.ajax({
				url:"import_order_products__train.php",
				success:function()
				{
		...
		{
			$.ajax({
				url:"process_order_products__train.php",
				success:function(data)
				{
